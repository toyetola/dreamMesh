    ...
    <div class="container" style="margin-top: 40px;">
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                <div class="box box-block bg-white col-md-8 offset-md-2 col-sm-12" style="margin-top: 40px;">
                    <h4>Welcome, add a talk attendee</h4>
                    <form>
                        <div class="col-md-12">
                            <div class="form-group col-md-3">
                                <label>Add attendee</label>
                                <input class="form-control" type="text" name="" id="attendee">
                            </div>
                            <div class="col-md-3"><button type="button" id="addattendee" class="btn btn-success" style="margin-top: 20px">Add</button>
                        </div>
                    </form>
                    <form action="" method="">
                        <div class="col-md-12">
                            <div class="form-group col-md-3">
                                ...
                                <select class="form-control" id="sattend">
                                    @foreach($attendees as $attendee)
                                        <option value="{{$attendee->id}}">{{$attendee->attendee}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-3">
                                <label>Select talk</label>
                                <select class="form-control" id="stalk">
                            ...
                            <div class="col-md-3"><button type="button" id="add" class="btn btn-success" style="margin-top: 20px">Add</button></div>

                        <div><a href="/getTalks">List all</a> </div>
                        </div>
...
<script>
    ...
    $('#addattendee').click(function(){
        var d = $('#attendee').val();
        $.post('/addAttendee', {attendee:d}, function (data) {
            console.log(data);
    ...
    $('#add').click(function(){
        var a = $('#sattend option:selected').val();
        var b = $('#stalk option:selected').val();
        $.post('',{'attendee':a, 'talk':b}, function (data) {
            console.log(data)
